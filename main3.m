% 本程序之目的为讨论动态模型下寄生虫与成体七鳃鳗的相互作用，恒定模型相关内容请见main7.m
%% 设置初始参数
clear
close all
clc
...
a=area(z(:,4));
a.FaceColor=[252/255,170/255,103/255];
a.EdgeColor=[252/255,170/255,103/255];
...
b=area(z(:,5));
b.FaceColor=1/255*[84,134,135];
b.EdgeColor=1/255*[255,255,199];
legend('Parasite')
ylabel('amount/100m^2','FontSize',14)
title('Parasite','FontSize',14);
grid
sgtitle('Parasite and adult lamprey population curves--dynamic model')
hold on
...
dxdt(4)=d21*x(1)*x(4)+d22*x(2)*x(4)-c2*x(4)-2*p*x(4)-b5*x(4)*x(5);
